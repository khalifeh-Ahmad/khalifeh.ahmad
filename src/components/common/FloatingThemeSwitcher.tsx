...
function FloatingThemeSwitcher({
  ...
  if (compact) {
    return (
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-1.5 shadow-[0_10px_35px_rgba(0,0,0,0.28)] backdrop-blur-xl">
        <div
          aria-hidden="true"
  ...
  // Standalone mode (kept for reuse if needed)
  return (
