  ...
  return (
    <div className="relative">
      <button
        ...
        onClick={() => setOpen((p) => !p)}
        className={cn(
          "group inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-gray-200",
          "shadow-[0_10px_30px_rgba(0,0,0,0.28)] backdrop-blur-xl transition",
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-[280px] overflow-hidden rounded-3xl border border-white/10 bg-[#0b1220]/80 shadow-[0_18px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl"
            role="dialog"
            aria-label="Background style"
          >
            <div className="p-3">
              <p className="px-2 py-1 text-[10px] uppercase tracking-[0.22em] text-gray-400">
                Choose a background
              </p>
              ...
              <div className="mt-3 border-t border-white/10 pt-3">
                <button
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-gray-200 transition hover:border-white/15 hover:bg-white/10 hover:text-white"
                >
                  Close
                </button>
              </div>
